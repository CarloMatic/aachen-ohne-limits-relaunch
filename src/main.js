...
const APP_DATA = {
  ...
  members: [
    ...
    // BRONZE (Der Rest)
    { name: 'Schrittmacher', tier: 'Bronze', category_de: 'Marke & Kommunikation', category_en: 'Branding & Communications' },
    ...
    { name: 'gpe', tier: 'Bronze', category_de: 'Entwicklung & Produktion', category_en: 'Development & Production' },
